...
class MainApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const MyHomePage(title: 'Daftar Games (Moch Renaldy 123)'),
    );
  }
}
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Future _ambilData() async {
    try {
      // MODIFIED LINE: Added parameters to filter by browser platform and sort alphabetically
      final response = await http.get(
        Uri.parse('https://www.freetogame.com/api/games?platform=browser&sort-by=alphabetical'),
      );
